...
export default function FormularioPelicula(props: formularioPeliculasProps) {
    ...
    useState(mapear(props.cinesNoSelecionados));
        ...
        >
            {formikProps => (
                <Form>
                    ...
                    <FomrGroupFecha label="Fecha Lanzamiento" campo="fechaLanzamiento" />
